              ...
              [
                Padding(
                  ...
                  child: Row(
                    ...
                    children:
                    [
                      Text("هيكل النادي",style: TextStyle(color: AppColors.kMainColor,fontWeight: FontWeight.bold,fontSize: 20.sp,overflow: TextOverflow.ellipsis),),
                      const Spacer(),
                      if( club.image != null )
                        Container(
                          height: 90.h,
                ...
                Expanded(
                  child: SingleChildScrollView(
                    ...
                    child: Container(
                      ...
                      child: Text(club.description != null ? club.description! : "لم يتم اضافة وصف للنادي حتى الآن",style: TextStyle(fontSize: 13.sp,fontWeight: FontWeight.w600,color: Colors.black.withOpacity(0.5)),),
                    ),
                  ),
                ),
              ],
