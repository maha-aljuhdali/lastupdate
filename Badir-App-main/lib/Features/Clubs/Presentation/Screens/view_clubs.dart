                        ...
                        if( myData != null && myData.idForClubLead == null && Constants.userID != null )    // TODO: AS it will be shown only if a Visitor or Member Not Leader....
                          _buttonItem(
                              ...
                              onTap: ()
                              {
                                ...
                                {
                                  showToastMessage(context: context, message: "لقد تم إيقاف الإنضمام للنادي من قبل القائد تبعه",backgroundColor: AppColors.kRedColor);
                                }
                                else
                                {
                                  showToastMessage(context: context, message: "تم طلب العضوية بالفعل وف انتظار موافقه القائد");
                                }
                              }
                          )
                      ],
