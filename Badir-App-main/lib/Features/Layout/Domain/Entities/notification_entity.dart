...
class NotificationEntity extends Equatable {
  final String? notifyType;   // ممكن في تطبيق المستخدم هتشك على نوعها لو هي ان اصبحت ليدر هستدعي الداله اللي بتجيب الداتا بتاعتي وف نفس الوقت الداتا بتاع النادي اللي انا قائد علىه
